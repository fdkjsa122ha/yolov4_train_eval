...
class map_eval:
    ...
    def box_relations_via_labels(self,label,conf_thresh,iou_threshold=0.5):
        ...
        for i in range(len(self.image_list)):
            ...
            detections                   = np.array(_detections, dtype=object)
...
if __name__ == '__main__':
    args = EasyDict()
    args.annotation_file = r"F:\1_project_store\2_dev_info\3_data_set\1_cv\7_car_pedestrain_detection\evaluation\true.txt"
    args.detection_file = r"F:\1_project_store\2_dev_info\3_data_set\1_cv\7_car_pedestrain_detection\evaluation\out.txt"
    ...
    args.input_dir = r"F:\1_project_store\2_dev_info\3_data_set\1_cv\7_car_pedestrain_detection\object-detection-crowdai"
